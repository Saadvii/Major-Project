...
--
-- Host: localhost
-- Generation Time: Aug 19, 2022 at 01:08 PM
...
--
-- Database: `phishing_url_detection`
--
CREATE DATABASE IF NOT EXISTS `phishing_url_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
('67qs1svz2xmwd6q4r687zpr1hwtozjfv', 'eyJ1c2VyaWQiOjJ9:1oP10V:UZVAdIUHPhFLFoJal7YnKtNtuAVpwOYqTGSyH8aL_Cg', '2022-09-02 12:21:47.240684'),
...
('he94aloj8dqlfdio44wwkgwon6am70i0', 'eyJ1c2VyaWQiOjN9:1oP1ey:ltAjv0oF_ghRuJI244mv8uwvsthIwgLbMt11adaKdY4', '2022-09-02 13:03:36.861339'),
...
(2, 'Ashok', 'Ashok123@gmail.com', 'Ashok', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Vijayanagar', 'Male'),
(3, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Malleshwaram', 'Male');
...
(57, 'Naive Bayes', '93.51957121974988'),
(58, 'SVM', '96.75978560987494'),
(59, 'Logistic Regression', '96.44307292512588'),
(60, 'SGD Classifier', '96.38622705863244');
...
--
-- Table structure for table `remote_user_url_detection_type`
--
...
--
-- Dumping data for table `remote_user_url_detection_type`
--

INSERT INTO `remote_user_url_detection_type` (`id`, `url_name`, `Prediction`) VALUES
(1, 'allmusic.com/album/crazy-from-the-heat-r16990', 'Non-Phishing'),
...
(8, 'http://florsiris.com/index.php?option=com_jevents&task=day.listevents&year=2013&month=01&day=25&Itemid=59', 'Defacement');
